# qcx_ultimate_gui_with_debug_console.py
# Optional debug console window — tick to enable
...
class QCXUltimateGUI:
    def __init__(self, root):
        ...
        tk.Scale(speed_frame, from_=5, to=40, orient=tk.HORIZONTAL, variable=self.speed_var, length=300, bg="#333333333", fg="white").pack()
