...
# QCX-mini / QMX ULTIMATE CAT CONTROL by AJ6BC + Grok
...
class QCXUltimateGUI:
    def __init__(self, root):
        ...
        ttk.Combobox(top_frame, textvariable=self.device_var, values=["QCX", "QMX"], width=5).pack(side=tk.LEFT, padx=5)
    ...
    def scan_loop(self):
        ...
        if width_str == "Full Band" and band == "40m":
            ...
            width_khz = 50       # fallback for other bands
        else:
