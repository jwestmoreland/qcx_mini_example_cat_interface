# qcx_ultimate_gui_presets_back.py
# Preset CW messages restored
...
class QCXUltimateGUI:
    def __init__(self, root):
        ...
        self.root.geometry("680x1000")  # Extra space for presets
        ...
        self.split_banner = tk.Label(vfo_frame, text="", fg="white", bg="#ff0000", font=("Arial", 20, "bold"))
        ...
        # === Custom Message (centered below presets) ===
        ...
        # === VFO A/B + Split + Practice Buttons (smaller) ===
        ...
        tk.Button(vfo_control_frame, text="PRACTICE", command=self.toggle_practice, bg="#00ffff", fg="black", font=("Arial", 12, "bold"), width=8, height=1).pack(side=tk.LEFT, padx=10)
    ...
    def toggle_practice(self):
        messagebox.showinfo("Practice Mode", "Practice Mode is set manually in the radio menu:\n8.7 Practice > On/Off\n(No CAT control available)")
