...
# - Clean layout, no overlap, one trainer button only
...
def open_cw_decoder(main_app):
    ...
    # Play Audio Tones checkbox - on its own separate line
    ...
    def audio_decoder():
        ...
        while decoding:
            try:
                ...
                # Lowered multiplier for more sensitivity on strong signals
                dynamic_thresh = avg_noise * 4  # ~12 dB - adjustable here if needed

                key_down = tone_mag > dynamic_thresh

                # Debug print to see why no key down
    ...
    def audio_decoder():
        ...
        while decoding:
            try:
                ...
                dynamic_thresh = avg_noise * 4  # lowered for more sensitivity
