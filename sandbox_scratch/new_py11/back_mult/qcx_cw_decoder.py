...
# - Live symbol building + enhanced status display
# - Noise/spike rejection + debounce
# - Symbol timing display
...
# Simple sine wave generator for trainer audio tones (moved up to be defined before use)
...
def open_cw_decoder(main_app):
    ...
    tk.Label(row2, text="Symbol:", fg="cyan", bg="#1a1a1a", font=("Arial", 12, "bold")).pack(side=tk.LEFT, padx=150)
