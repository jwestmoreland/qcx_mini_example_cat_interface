...
class QCXUltimateGUI:
    def __init__(self, root):
        ...
        # Band selection - FIXED: call update_bands BEFORE creating combo
        ...
        self.update_bands()  # <--- This line moved up to define supported_bands first

        self.band_combo = ttk.Combobox(band_frame, textvariable=self.band_var, values=self.supported_bands, width=6)
        ...
        # Update bands (called again if needed)
        self.update_bands()
    ...
    def update_bands(self):
        ...
        if hasattr(self, 'band_combo'):
            self.band_combo['values'] = self.supported_bands
