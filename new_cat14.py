# qcx_ultimate_gui_tb_fixed.py
# CW decode using QU1; + TB1; + TB; polling (page 50 OpMan108)
...
class QCXUltimateGUI:
    def __init__(self, root):
        ...
        # === Disclaimer ===
        disclaimer = tk.Label(root, text="This is an experimental CAT interface; use at your own risk. 100% no liability for damages whatsoever.",
    ...
    def connect(self):
        ...
        try:
            ...
            # Enable CW decoder notifications (page 50)
            self.send_cmd('QU1')
    ...
    # ... (rest of the methods unchanged — set_vfo, toggle_split, band_change, set_freq, rit, speed, messages, TX safety, debug console, etc.) ...
